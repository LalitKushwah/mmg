...
@IonicPage()
@Component({
  selector: 'page-selected-customer-order-list',
  templateUrl: 'selected-customer-order-list.html',
})
export class SelectedCustomerOrderListPage {
  ...
  async getUserOrderList () {
    const profile = await this.storageService.getFromStorage('selectedCustomer')
    console.log(profile)
